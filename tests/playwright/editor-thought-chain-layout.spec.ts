...
test("չ��˼ά���󶥲����ذ�ť�Ա����ڿ���������", async ({ page }) => {
  await page.addInitScript(() => {
    ...
    const streamPayload = `<think>\n��һ������������\n�ڶ�������ֽ���ṹ\n�����������뽻��ϸ��\n���Ĳ��������������\n</think>\n\n${JSON.stringify({
      projectName: "˼ά�����ֲ���ҳ",
      summary: "������֤չ��˼ά��ʱҳ�沼���Ƿ��ȶ���",
      assistantMessage: "�Ѿ�����ҳ��Ǽܣ�����������ϸ��˼�����̹���鿴��",
      thinkingSteps: [
        {
          id: "step-1",
          title: "��������",
  ...
  await page.locator("textarea").fill("��������һ�����ڲ���˼ά��չ����ҳ��");
