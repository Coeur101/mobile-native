...
## Purpose
Define the authenticated personal-profile experience, account presentation, and in-profile security controls.
...
- **WHEN** a signed-in user starts the "Set password" flow
...
- **WHEN** a signed-in user starts the "Reset password" flow
